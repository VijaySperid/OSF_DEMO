...
export const TestOSFDEMOwidget = () => import('../index');

describe('TestOSFDEMOwidget renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {TestOSFDEMOwidget};
  beforeAll(async () => {
    /**
  ...
  it('TestOSFDEMOwidget works as expected', async done => {
    /**
