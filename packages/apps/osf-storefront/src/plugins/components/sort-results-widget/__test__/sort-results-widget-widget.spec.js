...
export const SortResultsWidget = () => import('../index');

describe('SortResultsWidget renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {SortResultsWidget};
  beforeAll(async () => {
    /**
  ...
  it('SortResultsWidget works as expected', async done => {
    /**
