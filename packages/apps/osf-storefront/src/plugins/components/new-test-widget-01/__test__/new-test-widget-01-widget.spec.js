...
export const NewTestWidget01 = () => import('../index');

describe('NewTestWidget01 renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {NewTestWidget01};
  beforeAll(async () => {
    /**
  ...
  it('NewTestWidget01 works as expected', async done => {
    /**
