...
export const SortFilterCustom = () => import('../index');

describe('SortFilterCustom renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {SortFilterCustom};
  beforeAll(async () => {
    /**
  ...
  it('SortFilterCustom works as expected', async done => {
    /**
