...
export const TestWidgetOne = () => import('../index');

describe('TestWidgetOne renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {TestWidgetOne};
  beforeAll(async () => {
    /**
  ...
  it('TestWidgetOne works as expected', async done => {
    /**
