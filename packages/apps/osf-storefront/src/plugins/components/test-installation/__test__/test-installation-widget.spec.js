...
export const TestInstallation = () => import('../index');

describe('TestInstallation renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {TestInstallation};
  beforeAll(async () => {
    /**
  ...
  it('TestInstallation works as expected', async done => {
    /**
